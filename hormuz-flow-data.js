window.HORMUZ_FLOW_DATA = {
  "generatedAt": "2026-03-17T03:38:00Z",
  "source": {
    "name": "UKMTO/JMIC + Windward + Kpler + 第三方监测数据",
    "url": "https://www.ukmto.org/partner-products/jmic-products/jmic-advisories/2026",
    "method": "历史序列按来源分开：UKMTO/JMIC、Windward 与 Kpler；实时补点来自第三方监测数据。"
  },
  "sourceSeries": {
    "ukmto": {
      "name": "英国联合海事资讯中心（JMIC/UKMTO）",
      "url": "https://www.ukmto.org/partner-products/jmic-products/jmic-advisories/2026",
      "method": "优先使用本地表格数据（货船/油轮/总计）；缺失时回退 UKMTO/JMIC 公告自动提取。",
      "globalRemark": "注意：数据来自英国联合海事资讯中心及标普，统计对象为1000总吨及以上且开启自动识别系统的货运船舶。基于自动识别系统的通行数据仅涵盖主动发送信号的船舶，可能无法追踪到关闭自动识别系统或受卫星导航干扰的船只，因此实际海峡通行量可能与当前观测数据存在差异。",
      "records": [
        {
          "date": "2026-02-28",
          "cargoCrossings": 98.0,
          "tankerCrossings": 50.0,
          "totalCrossings": 148.0,
          "remark": "UKMTO/JMIC + 标普，AIS口径"
        },
        {
          "date": "2026-03-01",
          "cargoCrossings": 18.0,
        ...
        },
        {
          ...
          "tankerCrossings": 0.0,
          "totalCrossings": 3.0,
          "remark": "UKMTO/JMIC + 标普，AIS口径（你提供的图表）"
        }
      ]
    },
    "windward": {
      ...
      "globalRemark": "数据源自 Windward。受近期地缘局势骤然升级影响，霍尔木兹海峡及周边海域出现大规模卫星定位信号干扰，且大量商船为规避风险选择关闭自动识别系统进行静默航行或直接绕道，导致近期观测到的海峡实际通行量数据急剧萎缩。",
      "records": [
        {
          "date": "2026-02-28",
          "inboundCrossings": 0.0,
          "outboundCrossings": 52.0,
          "totalCrossings": 52.0,
          "remark": "Windward口径"
        },
        {
          "date": "2026-03-01",
          "inboundCrossings": 4.0,
          "outboundCrossings": 14.0,
          "totalCrossings": 18.0,
          "remark": "Windward口径"
        },
        {
          "date": "2026-03-02",
          "inboundCrossings": 3.0,
          "outboundCrossings": 4.0,
          "totalCrossings": 7.0,
          "remark": "Windward口径"
        },
        {
          "date": "2026-03-03",
          "inboundCrossings": 2.0,
          "outboundCrossings": 2.0,
          "totalCrossings": 4.0,
          "remark": "Windward口径"
        },
        {
          "date": "2026-03-04",
          "inboundCrossings": 4.0,
          "outboundCrossings": 1.0,
          "totalCrossings": 5.0,
          "remark": "Windward口径"
        },
        {
          "date": "2026-03-07",
          "inboundCrossings": 1.0,
          "outboundCrossings": 2.0,
          "totalCrossings": 3.0,
          "remark": "Windward口径"
        },
    ...
    "kpler": {
      ...
      "method": "MarineTraffic页面抓取受Cloudflare拦截，当前使用手工Excel口径。",
      "globalRemark": "口径字段：被制裁船只/影子船只/其他常规船只/总通行量；日期为Excel序列日期。",
      "records": [
        {
          "date": "2026-03-15",
          "sanctionedVessels": 2.0,
          "shadowVessels": 1.0,
          "otherRegularVessels": 2.0,
          "totalCrossings": 5.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          "date": "2026-03-14",
          "sanctionedVessels": 1.0,
          "shadowVessels": 1.0,
          "otherRegularVessels": 2.0,
          "totalCrossings": 4.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          ...
          "sanctionedVessels": 1.0,
          "shadowVessels": 0.0,
          "otherRegularVessels": 0.0,
          "totalCrossings": 1.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          "date": "2026-03-12",
          "sanctionedVessels": 0.0,
          "shadowVessels": 1.0,
          "otherRegularVessels": 1.0,
          "totalCrossings": 2.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          "date": "2026-03-11",
          "sanctionedVessels": 3.0,
          "shadowVessels": 1.0,
          "otherRegularVessels": 4.0,
          "totalCrossings": 8.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          "date": "2026-03-10",
          "sanctionedVessels": 4.0,
          "shadowVessels": 0.0,
          "otherRegularVessels": 2.0,
          "totalCrossings": 6.0,
          "remark": "Kpler口径（手工Excel）"
        ...
        },
        {
          ...
          "sanctionedVessels": 1.0,
          "shadowVessels": 1.0,
          "otherRegularVessels": 7.0,
          "totalCrossings": 9.0,
          "remark": "Kpler口径（手工Excel）"
        },
        {
          "date": "2026-03-01",
          "sanctionedVessels": 6.0,
          "shadowVessels": 3.0,
          "otherRegularVessels": 20.0,
          "totalCrossings": 29.0,
          "remark": "Kpler口径（手工Excel）"
        }
      ]
  ...
  "summary": {
    ...
    "latestTrafficDate": "2026-03-17",
    "latestCrossings": 2.0,
    "previousTrafficDate": "2026-03-15",
    "previousCrossings": 3.0,
    "dayOverDayPct": -33.33333333333333,
    "sevenDayAverage": 60.0,
    "gapToWeekAveragePct": -96.66666666666667,
    "collapseFromStartPct": -96.15384615384616,
    "status": "通行量仍处于冻结区间",
    "latestReportDate": "2026-03-17",
  ...
  "realtimeSignals": {
    "lastUpdated": "2026-03-17T03:38:00.061Z",
    "sourceName": "第三方监测数据",
    "status": "RESTRICTED",
    "statusDescription": "Effectively closed to US-allied vessels and Western shipping; selectively open to non-Western countries (China, India, Turkey, Pakistan) based on individual negotiation with Iran. Iran allows its own oil exports freely.",
    "shipCountLast24h": 2,
    "shipCountCurrentTransits": 1,
    "shipCountNormalDaily": 60,
    "shipCountPercentOfNormal": 1.5,
    "strandedVesselsTotal": 150,
    "strandedVesselsChangeToday": -2,
    "brentPrice": 91.47,
    "brentChangePct24h": 4.36,
    "insuranceMultiplier": 10,
    "throughputPercentOfNormal": 0.15,
    "referenceSources": [
      "第三方监测数据"
    ]
  },
  ...
  "points": [
    {
      ...
      "sourceUrl": "https://windward.ai/blog/",
      "crossings": 52.0,
      "exact": true,
    ...
    {
      "trafficDate": "2026-03-17",
      "reportDate": "2026-03-17",
      "reportTitle": "第三方监测数据 Realtime Dashboard",
      "sourceUrl": "",
      "crossings": 2.0,
      "exact": true,
      "note": "第三方监测数据显示过去24小时通行为 2，当前在途 1，常态日均约 60。",
      "sevenDayAverage": 60.0,
      "inbound": null,
      "outbound": null,
      "other": null,
  ...
  "caveats": [
    "最新可量化点来自第三方监测数据，更新日期 2026-03-17，过去24小时通行为 2。",
